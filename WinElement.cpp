...
static int bpos[MAXATNUM+1+2][2] =  {{ 7,0},{ 0,0},{17,0},{ 0,1},
...
WinElement::WinElement( QWidget *parent , int guess )
               : QDialog( parent ) 
{
  int i;
...
void WinElement::SetDefaultElement() 
{
  int i; 
...
int WinElement::GetSelectedElement( )
{
